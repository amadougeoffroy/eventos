...
const opulence: TemplateDesign = {
  id: 'opulence',
  name: 'Opulence',
  description:
    'Éclat doré et raffinement absolu. Un thème lumineux et luxueux pour des célébrations grandioses.',
  plan: 'premium',
  fonts: { display: 'Playfair Display', body: 'Cormorant Garamond', script: 'Tangerine' },
  heroTypes: ['image', 'slideshow', 'video'],
  layout: 'modern',
  ...
  variants: {
    wedding: {
      ...
      defaultHeroImages: heroImages('wedding', 'opulence', 5),
      particles: 'petals',
    },
    birthday: {
      palette: {
      ...
      defaultHeroImages: heroImages('birthday', 'opulence', 5),
      particles: 'balloons',
    },
    baptism: {
      palette: {
      ...
      defaultHeroImages: heroImages('baptism', 'opulence', 5),
      particles: 'doves',
    },
    party: {
      palette: {
      ...
      defaultHeroImages: heroImages('party', 'opulence', 5),
      particles: 'stars',
    },
    babyshower: {
      palette: {
      ...
      defaultHeroImages: heroImages('babyshower', 'opulence', 5),
      particles: 'hearts',
    },
    corporate: {
      palette: {
      ...
      defaultHeroImages: heroImages('corporate', 'opulence', 5),
      particles: 'confetti',
    },
    custom: {
      palette: {
      ...
      defaultHeroImages: heroImages('custom', 'opulence', 5),
      particles: 'confetti',
    },
  },
};
