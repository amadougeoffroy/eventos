  ...
  return (
    <section style={{ background: 'var(--t-bg, var(--bg))', padding: '5rem 1.5rem' }}>
      ...
      >
        ...
        <p className="text-2xl md:text-3xl italic leading-relaxed" style={{ fontFamily: 'var(--t-font-display, var(--font-display))', color: 'var(--t-text-muted, var(--text-secondary))' }}>
